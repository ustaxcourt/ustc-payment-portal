...
for func in initPayment processPayment getDetails testCert migrationRunner getAllTransactions getTransactionsByStatus getTransactionPaymentStatus initRefGenerator processTokenMinter powerTuningCleanUp; do
