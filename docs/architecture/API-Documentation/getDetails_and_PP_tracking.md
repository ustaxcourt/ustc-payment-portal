**PREFACE: THE FOLLOWING DESCRIBES THE UPCOMING DESIGN FOR THE PAYMENT PORTAL API, INCLUDING THE USE OF UUIDS AND METADATA FOR TRANSACTION TRACKING. THIS IMPLEMENTATION IS PLANNED AND NOT YET LIVE.**
