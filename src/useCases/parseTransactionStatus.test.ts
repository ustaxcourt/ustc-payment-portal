...
describe("parseTransactionStatus", () => {
	it.each([
		"Success",
		"Settled",
	] as PayGovTransactionStatus[])("Returns Processed for all successful transaction statuses", (transactionStatus: PayGovTransactionStatus) => {
	...
	it.each([
		...
		"Cancelled",
		"Retired",
	] as PayGovTransactionStatus[])("Returns 'failed' for Failed, Cancelled, and Retired transaction statuses", (transactionStatus: PayGovTransactionStatus) => {
	...
	it.each([
		...
		"Received",
		"Waiting",
	] as PayGovTransactionStatus[])("Returns pending for all pending transaction statuses", (transactionStatus: PayGovTransactionStatus) => {
