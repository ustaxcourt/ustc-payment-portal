import pino, { LoggerOptions } from "pino/pino";
...
// export function createRequestLogger(context: GetPortalLogger) {
//   return logger.child(context);
// }

export function createRequestLogger(opts: LoggerOptions = {}): LoggerType {
  const options = {
    defaultMeta: {},
    ...opts,
  };
  ...
  return Object.assign(
    Object.create(Object.getPrototypeOf(childLogger)),
    childLogger,
    {
