...
export const TransactionRecordSummarySchema = z
	.object({
		payGovTrackingId: z.string().optional().openapi({
			description:
				"Pay.gov tracking ID for the transaction, present once the transaction has been processed",
			example: "TRK-123456789",
		}),
		transactionStatus: TransactionStatusSchema,
		paymentMethod: PaymentMethodSchema.optional(),
...
export type TransactionRecordSummary = z.infer<
	typeof TransactionRecordSummarySchema
>;
